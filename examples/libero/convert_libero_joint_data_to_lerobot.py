...
NO_IMAGE_REPO_NAME = "libero-joint-no-image"  # Name of the output dataset, also used for the Hugging Face Hub
REPO_NAME = "libero-joint"  # Name of the output dataset, also used for the Hugging Face Hub
RAW_DATASET_NAMES = [
    "libero_10",
    "libero_goal",
    "libero_object",
